...
from SimulationImageMasker import BlackWhiteRenderer
...
if __name__ == '__main__':
    ...
    image_path = "SimulationImageMasker/ImageReader/Images/UNCLogo.jpeg"  # Path to black & white image you're using
    image_frame = get_final_frame(input_gsd) - 1  # Frame where the image comes together

    renderer = BlackWhiteRenderer.BlackWhiteRenderer(input_gsd,
                                                     output_gsd,
                                                     num_bins,
                                                     image_path,
                                                     image_frame)
