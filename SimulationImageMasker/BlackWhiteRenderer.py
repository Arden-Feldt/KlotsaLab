        ...
        with gsd.hoomd.open(name=self.input_gsd, mode="r") as file:
            ...
            for frame_index, frame in enumerate(file):
                if frame_index == self.image_frame:
                    ...
                    colorlist = image_reader.read_black_and_white()
                    ...
                    p_names = binner.black_and_white_bin(get_x_box_dim(self.input_gsd), get_y_box_dim(self.input_gsd))
